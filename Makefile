...
am__append_1 = neoscrypt_asm.S
am__append_2 = sha2-x86.S scrypt-x86.S 
#am__append_3 = sha2-x64.S scrypt-x64.S
#am__append_4 = sha2-arm.S scrypt-arm.S
subdir = .
...
am__minerd_SOURCES_DIST = elist.h miner.h compat.h cpu-miner.c util.c \
	sha2.c scrypt.c neoscrypt.c neoscrypt.h neoscrypt_asm.S \
	sha2-x86.S scrypt-x86.S sha2-x64.S scrypt-x64.S sha2-arm.S \
	scrypt-arm.S
am__objects_1 = minerd-neoscrypt_asm.$(OBJEXT)
am__objects_2 =  \
...
am_minerd_OBJECTS = minerd-cpu-miner.$(OBJEXT) minerd-util.$(OBJEXT) \
	...
	minerd-neoscrypt.$(OBJEXT) $(am__objects_1) $(am__objects_2) \
	$(am__objects_3) $(am__objects_4)
minerd_OBJECTS = $(am_minerd_OBJECTS)
minerd_DEPENDENCIES = /local/lib/libcurl.a /c/MinGW/lib/libpthread.a
minerd_LINK = $(CCLD) $(AM_CFLAGS) $(CFLAGS) $(minerd_LDFLAGS) \
	$(LDFLAGS) -o speed-autoclicker-d.exe
DEFAULT_INCLUDES = -I.
...
ACLOCAL = ${SHELL} /c/dev/coins/cpuminer-neoscrypt/missing --run aclocal-1.11
ALLOCA = 
AMTAR = ${SHELL} /c/dev/coins/cpuminer-neoscrypt/missing --run tar
AUTOCONF = ${SHELL} /c/dev/coins/cpuminer-neoscrypt/missing --run autoconf
AUTOHEADER = ${SHELL} /c/dev/coins/cpuminer-neoscrypt/missing --run autoheader
AUTOMAKE = ${SHELL} /c/dev/coins/cpuminer-neoscrypt/missing --run automake-1.11
AWK = gawk
CC = gcc
CCAS = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /c/dev/coins/cpuminer-neoscrypt/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = cpuminer
PACKAGE_BUGREPORT = 
...
VERSION = 2.4
WS2_LIBS = -lws2_32
abs_builddir = /c/dev/coins/cpuminer-neoscrypt
abs_srcdir = /c/dev/coins/cpuminer-neoscrypt
abs_top_builddir = /c/dev/coins/cpuminer-neoscrypt
abs_top_srcdir = /c/dev/coins/cpuminer-neoscrypt
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /c/dev/coins/cpuminer-neoscrypt/install-sh
...
minerd_SOURCES = elist.h miner.h compat.h cpu-miner.c util.c sha2.c \
	scrypt.c neoscrypt.c neoscrypt.h $(am__append_1) \
	$(am__append_2) $(am__append_3) $(am__append_4)
minerd_LDFLAGS = $(PTHREAD_FLAGS) -s
minerd_LDADD = /local/lib/libcurl.a compat/jansson/libjansson.a /c/MinGW/lib/libpthread.a -lwldap32 -lws2_32
minerd_CPPFLAGS = -I/local/include -DCURL_STATICLIB -O3 -fomit-frame-pointer -DNEOMIN -DMINER_SILENT_no  -s -DASM -DUSE_ASM -DOPT -DMINER_4WAY -DSHA256
...
include ./$(DEPDIR)/minerd-neoscrypt.Po
include ./$(DEPDIR)/minerd-neoscrypt_asm.Po
...
minerd-neoscrypt_asm.o: neoscrypt_asm.S
	$(CCAS) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CCASFLAGS) $(CCASFLAGS) -MT minerd-neoscrypt_asm.o -MD -MP -MF $(DEPDIR)/minerd-neoscrypt_asm.Tpo -c -o minerd-neoscrypt_asm.o `test -f 'neoscrypt_asm.S' || echo '$(srcdir)/'`neoscrypt_asm.S
	$(am__mv) $(DEPDIR)/minerd-neoscrypt_asm.Tpo $(DEPDIR)/minerd-neoscrypt_asm.Po
#	source='neoscrypt_asm.S' object='minerd-neoscrypt_asm.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCASDEPMODE) $(depcomp) \
#	$(CCAS) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CCASFLAGS) $(CCASFLAGS) -c -o minerd-neoscrypt_asm.o `test -f 'neoscrypt_asm.S' || echo '$(srcdir)/'`neoscrypt_asm.S

minerd-neoscrypt_asm.obj: neoscrypt_asm.S
	$(CCAS) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CCASFLAGS) $(CCASFLAGS) -MT minerd-neoscrypt_asm.obj -MD -MP -MF $(DEPDIR)/minerd-neoscrypt_asm.Tpo -c -o minerd-neoscrypt_asm.obj `if test -f 'neoscrypt_asm.S'; then $(CYGPATH_W) 'neoscrypt_asm.S'; else $(CYGPATH_W) '$(srcdir)/neoscrypt_asm.S'; fi`
	$(am__mv) $(DEPDIR)/minerd-neoscrypt_asm.Tpo $(DEPDIR)/minerd-neoscrypt_asm.Po
#	source='neoscrypt_asm.S' object='minerd-neoscrypt_asm.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCASDEPMODE) $(depcomp) \
#	$(CCAS) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CCASFLAGS) $(CCASFLAGS) -c -o minerd-neoscrypt_asm.obj `if test -f 'neoscrypt_asm.S'; then $(CYGPATH_W) 'neoscrypt_asm.S'; else $(CYGPATH_W) '$(srcdir)/neoscrypt_asm.S'; fi`
...
minerd-neoscrypt.o: neoscrypt.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-neoscrypt.o -MD -MP -MF $(DEPDIR)/minerd-neoscrypt.Tpo -c -o minerd-neoscrypt.o `test -f 'neoscrypt.c' || echo '$(srcdir)/'`neoscrypt.c
	$(am__mv) $(DEPDIR)/minerd-neoscrypt.Tpo $(DEPDIR)/minerd-neoscrypt.Po
#	source='neoscrypt.c' object='minerd-neoscrypt.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-neoscrypt.o `test -f 'neoscrypt.c' || echo '$(srcdir)/'`neoscrypt.c

minerd-neoscrypt.obj: neoscrypt.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-neoscrypt.obj -MD -MP -MF $(DEPDIR)/minerd-neoscrypt.Tpo -c -o minerd-neoscrypt.obj `if test -f 'neoscrypt.c'; then $(CYGPATH_W) 'neoscrypt.c'; else $(CYGPATH_W) '$(srcdir)/neoscrypt.c'; fi`
	$(am__mv) $(DEPDIR)/minerd-neoscrypt.Tpo $(DEPDIR)/minerd-neoscrypt.Po
#	source='neoscrypt.c' object='minerd-neoscrypt.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-neoscrypt.obj `if test -f 'neoscrypt.c'; then $(CYGPATH_W) 'neoscrypt.c'; else $(CYGPATH_W) '$(srcdir)/neoscrypt.c'; fi`
